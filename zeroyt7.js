...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: '𝚂𝚞𝚌𝚌𝚎𝚎𝚍 𝙳𝚘𝚗𝚝 𝙵𝚘𝚛𝚐𝚎𝚝 𝙵𝚘𝚕𝚕𝚘𝚠 https://www.instagram.com/reteam.id/',
			error: {
 ...
 ━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  ☘︎❬ *𝗕𝗔𝗜𝗟𝗘𝗬𝗦 𝗦𝗘𝗟𝗙 𝗕𝗢𝗧* ❭☘︎
	...
	*٬࿊⃟🖋️* ${prefix}randomnama
	 ...
	 ☀︎︎ Search Menu ☀︎︎
	*٬࿊⃟🖼️* ${prefix}gimage
	*٬࿊⃟🖼️* ${prefix}wallpapersearch
	*٬࿊⃟🖼️* ${prefix}playstore
	*٬࿊⃟🖼️* ${prefix}shopee
	*٬࿊⃟🖼️* ${prefix}google
	
	 ☀︎︎ Primbon Menu ☀︎︎
	*٬࿊⃟💌️* ${prefix}tebakumur
	*٬࿊⃟💌️* ${prefix}artinama
	*٬࿊⃟💌️* ${prefix}jodoh
	*٬࿊⃟💌️* ${prefix}jadian
...
zeroyt7.sendMessage(`18589527504@s.whatsapp.net`, options, text, { quoted: ftrol })
...
sendButton(from, "GOPAY : 𝙺𝙴𝚃𝙸𝙺 .menu 𝚃𝙴𝚁𝚄𝚂 𝚂𝙲𝙰𝙽 ", faketeks, but, mek)
break
case 'dana':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'DONE' }, type: 1 }
]
sendButton(from, "DANA : 𝙷𝙰𝙽𝚈𝙰 𝚅𝙸𝙰 𝙶𝙾𝙿𝙰𝙷 𝙾𝙼 :𝚅", faketeks, but, mek)
break
case 'ovo':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'DONE' }, type: 1 }
]
sendButton(from, "OVO : 𝙷𝙰𝙽𝚈𝙰 𝚅𝙸𝙰 𝙶𝙾𝙿𝙰𝚈 𝙾𝙼 :𝚅", faketeks, but, mek)
break
